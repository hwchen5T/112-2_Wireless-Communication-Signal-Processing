...
average_SER_MMSE = zeros(1,length(SNR));
average_SER_MMSE_OSIC = zeros(1,length(SNR));
average_SER_K_best = zeros(1,length(SNR));
average_SER_ML = zeros(1,length(SNR));
...
title(sprintf('(c) £l = %g', channel_rho)) % a,b,c,d
grid on
toc